...
bot = TeleBot(token='5817953029:AAE-nqOwYl-VSEDX64HD0bzUagWQSbkGZ1U
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я могу проверить синтаксис твоего JSON и преобразовать его в читабельный вид\nВведи JSON в виде строки:', # текст сообщения
    )
